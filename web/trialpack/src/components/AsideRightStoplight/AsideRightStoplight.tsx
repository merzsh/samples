...
import * as styles from './AsideRightStoplight.modules.scss';
...
export const AsideRightStoplight: React.FC<IAsideRightEditor2d> = ({title}): JSX.Element => {
...
export default observer(AsideRightStoplight);
