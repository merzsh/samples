...
import * as styles from './MainHeaderHome.modules.scss';
...
import {
  ...
  STR_CLASS_HEADER__BACK__LEFT__SELECTOR, STR_CLASS_HEADER__BACK__RIGHT, STR_FILE_EXT_PNG,
  STR_FILENAME_GO,
  STR_FILENAME_GO_PNG,
  STR_FILENAME_IMG,
...
require(`../../../../${STR_FILENAME_RESOURCES}/${STR_FILENAME_UP}/${STR_FILENAME_UP}.png`);
require(`../../../../${STR_FILENAME_RESOURCES}/${STR_FILENAME_GO}/${STR_FILENAME_GO}.png`);

interface IHeaderHome {
  title: string;
}

export const MainHeaderHome: React.FC<IHeaderHome> = ({title}): JSX.Element => {
