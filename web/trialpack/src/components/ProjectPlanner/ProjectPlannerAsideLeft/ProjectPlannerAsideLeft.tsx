...
import * as styles from './ProjectPlannerAsideLeft.modules.scss';
...
export const ProjectPlannerAsideLeft: React.FC<IEditor2dAsideLeft> = ({title}): JSX.Element => {
...
export default observer(ProjectPlannerAsideLeft);
